...
Objetivo: elegir el patrón **mínimo** que resuelve el problema real, no decorar el código con patrones por moda. En este repo el dominio está en **español** y ya se usan Singleton, Command, Decorator y Composite (ver `CLAUDE.md`).
...
- Para extender un patrón existente, sigue el mismo molde (ej. nuevo comando → ver `CLAUDE.md`).
